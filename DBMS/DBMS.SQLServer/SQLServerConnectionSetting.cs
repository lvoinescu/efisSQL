...
namespace DBMS.SQLServer
{
    ...
    [XmlRootAttribute("SQLServerConnection", Namespace = "", IsNullable = false)]
    public class SQLServerConnectionSetting : ConnectionSetting , IConnectionSetting
    {
        /// <summary>
        /// Default constructor for this class (required for serialization).
        /// </summary>
        public SQLServerConnectionSetting()
        {
        }
        
        public SQLServerConnectionSetting(string connectionName):base()
        {
